 ...
 */
const routes = new Set(["home", "studios", "builder", "visual", "prompt", "prompt-preview", "prompt-history", "ai-image", "image-gallery", "provider-settings", "test-mode", "saved", "settings", "components"]);

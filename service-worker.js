const CACHE_NAME="nyvera-app-shell-v1.19.0-persistent-iheart-reveal";
const APP_SHELL=["./","./index.html","./manifest.webmanifest","./assets/icons/nyvera-mark.svg","./assets/icons/nyvera-mark-192.png","./assets/icons/nyvera-mark-512.png","./assets/icons/radio.svg","./assets/icons/studio-icons.svg","./assets/artwork/studio-character-ai.jpg","./assets/artwork/studio-kids-ai.jpg","./assets/artwork/studio-sticker-ai.jpg","./assets/illustrations/character-loading.svg","./assets/illustrations/kids-loading.svg","./assets/illustrations/sticker-loading.svg","./css/nyvera.css?v=1.14.0","./css/radio.css?v=1.17.0","./css/unveiled.css?v=1.1.0","./js/app.js?v=1.19.0","./js/nyvera-content.js","./js/nyvera-data.js?v=1.15.0","./js/nyvera-storage.js","./js/nyvera-prompts.js?v=1.15.0","./js/nyvera-mockups.js","./js/nyvera-kids-safety.js?v=1.15.0","./js/nyvera-kids-products.js?v=1.15.0","./js/nyvera-adult-products.js?v=1.13.0","./js/nyvera-unveiled.js?v=1.1.0","./js/nyvera-workflows.js?v=1.15.0","./js/radio.js?v=1.17.0","./js/radio-explorer.js","./js/radio-service.js","./js/radio-storage.js"];

...
test("production build and app shell include the Kids product module",()=>{assert.match(build,/nyvera-kids-products\.js/g);assert.match(sw,/nyvera-kids-products\.js/);assert.match(sw,/v1\.10\.3-mobile-delivery-refresh/);});

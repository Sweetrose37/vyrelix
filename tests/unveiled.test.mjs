...
test("production package and cache include Unveiled and permit the official iHeart frame",()=>{for(const text of ["css\\unveiled.css","js\\nyvera-unveiled.js"])assert.match(build,new RegExp(text.replace(/\\/g,"\\\\")));assert.match(html,/unveiled\.css\?v=1\.0\.0/);assert.match(html,/app\.js\?v=1\.17\.0/);assert.match(html,/frame-src https:\/\/www\.iheart\.com/);assert.match(sw,/v1\.17\.0-unveiled/);assert.match(sw,/nyvera-unveiled\.js\?v=1\.0\.0/)});
